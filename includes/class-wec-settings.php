            ...
            <div class="wec-settings-grid">
                ...
                <div class="wec-card wec-card-main">
                    ...
                    <form action="options.php" method="post" class="wec-settings-form">
                        ...
                        <!-- Global API Key -->
                        <div class="wec-form-group">
                            <label for="<?php echo esc_attr(self::OPT_GLOBAL_KEY); ?>">
                                <span class="wec-label-icon">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path>
                                    </svg>
                                </span>
                                <?php esc_html_e('Global API Key', 'whatsapp-evolution-clients'); ?>
                                <?php if ($has_global_key): ?>
                            ...
                            <div class="wec-input-wrapper">
                                <input type="password" 
                                    id="<?php echo esc_attr(self::OPT_GLOBAL_KEY); ?>"
                                    name="<?php echo esc_attr(self::OPT_GLOBAL_KEY); ?>" 
                                    value="<?php echo $has_global_key ? '••••••••••••••••' : ''; ?>"
                                    class="wec-input wec-input-password"
                                    placeholder="<?php echo $has_global_key ? '' : esc_attr__('Sua API Key global', 'whatsapp-evolution-clients'); ?>" />
                            ...
                            <span class="wec-input-hint">
                                <?php esc_html_e('Token global para gerenciar instâncias', 'whatsapp-evolution-clients'); ?>
                                <?php if ($has_global_key): ?>
